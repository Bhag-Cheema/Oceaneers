              ...
              <div className="row">
                <div className="col-4">
                  <div className="card-ambassador">
                    <img id="cirlce-2" src={ambassador1circle} className="rounded-circle-am" alt="..." />
                  </div>
                </div>
                <div className="col-8">
          ...
          <div className="accordion-body-about">
            <div className="container-2 d-flex justify-content-center">
              <div className="row">
                <div className="col-4">
                  <div className="card-ambassador">
                    <img id="cirlce-2" src={ambassador2} className="rounded-circle-am" alt="..." />
                  </div>
                </div>
                <div className="col-8">
                  <h2 className="repeating-h2-name">
                  ...
                  plant-based nutrition. Having grown up in Durban and now living on the Sunshine Coast, Tammy has never
                  strayed away for her love for the oceans. When Tammy isn’t in the water, she runs the Marketing department of
                  Fry’s Family Foods, the iconic producer of plant-based foods founded by her father in 1991. She is also the
                  director of Meat Free Mondays in Australia and South Africa, often found speaking on national and international
          ...
          <div className="accordion-body-about">
            <div className="container-2 d-flex justify-content-center">
              <div className="row">
                <div className="col-4">
                  <div className="card-ambassador">
                    <img id="cirlce-2" src={ambassador3} className="rounded-circle-am" alt="..." />
                  </div>
                </div>
                <div className="col-8">
                  <h2 className="repeating-h2-name">
                  ...
                  through sharing personal stories, creating, and investing in ocean-related projects. In fact, Terence swam around
                  the Hawaiian Island of Kauai, covering around 100 miles (180km) and swimming about 5 hours per day. This solo
                  swim was a world-first and had the intention of increasing global awareness about our responsibilities as humans
                  for the planet. He has partnered with Sustainable Coastlines Hawaii (SCH), a non-profit organization that works
          ...
          <div className="accordion-body-about">
            <div className="container-2 d-flex justify-content-center">
              <div className="row">
                <div className="col-4">
                  <div className="card-ambassador">
                    <img id="cirlce-2" src={ambassador4} className="rounded-circle-am" alt="..." />
                  </div>
                </div>
                <div className="col-8">
                  <h2 className="repeating-h2-name">
                  ...
                  the tender age of 19, Emi started a non-profit called Beyond The Surface International, an initiative that “works at
                  the local level with remote and marginalized small-scale fishing communities for social-ecological wellbeing.”
                  Beyond the Surface has partnered with coastal communities from Jamaica to India. They use surfing, mindfulness
                  and participatory media as tools to engage local communities around marine conservation, climate change
              ...
              <div className="row">
                <div className="col-4">
                  <div className="card-ambassador d-flex justify-content-center">
                    <img id="cirlce-2" src={team1} className="rounded-circle-am" alt="..." />
                  </div>
                  <h4 className="h4 d-flex justify-content-center">
                    “No other human activity is as damaging to our{" "}<br /> living planet
                  as industrial fishing and livestock{" "}<br /> farming – the challenge
                  is that still few people {" "}<br />are aware of that. ”
                  </h4>
                </div>
                <div className="col-8">
                  <h2 className="repeating-h2-name">
                  ...
                  <ul className="list">
                    ...
                    <li className="il">Does his first Vipassana retreat (10-day silent meditation based on
                      Buddha’s teachings) in 2014, emerging even more inpsired to reduce suffering of all living beings</li>
                    <li className="il">Becomes active in reduction advocacy, e.g. by collecting signatures for a initiative to ban factory
                      farming in Switzerland</li>
                    <li className="il">Eats now 95% plant-based and enjoys each meal in which he supports a flourishing plant-based food industry</li>
                  </ul>
                </div>
          ...
          <div className="accordion-body-about">
            <div className="container-2 d-flex justify-content-center">
              <div className="row">
                <div className="col-4">
                  <div className="card-ambassador">
                    <img id="cirlce-2" src={team2} className="rounded-circle-am" alt="..." />
                  </div>
                  <h4 className="h4 d-flex justify-content-center">
                    “The oceans have shaped and moulded me into the person that I am today.
                    They have instilled in me a passion for nature and all things living.”
                  </h4>
                </div>
                <div className="col-8">
                  <h2 className="repeating-h2-name">
          ...
          <div className="accordion-body-about">
            <div className="container-2 d-flex justify-content-center">
              <div className="row">
                <div className="col-4">
                  <div className="card-ambassador">
                    <img id="cirlce-2" src={team3} className="rounded-circle-am" alt="..." />
                  </div>
                  <h4 className="h4 d-flex justify-content-center">
                    “[The ocean] has been my reprieve from the world,{" "}<br />my therapist and
                  my coach and too often,{" "}<br />a best friend."
                  </h4>
                </div>
                <div className="col-8">
                  <h2 className="repeating-h2-name">
                  ...
                  <ul>
                    ...
                    <li className="il">Exposure to a plant-based lifestyle made him realise a transition to a plant-based diet was
                    the best way to advocate for conservation and sustainability</li>
                    <li className="il">Switched back to fully vegetarian during serious yoga and meditation studies</li>
                    <li className="il">Settled into flexitarianism in a 90% plant-based ratio in 2016 with flexibility
                    around social situations and opting for ethical wherever possible</li>
                  </ul>
                </div>
